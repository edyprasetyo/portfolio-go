...
<div id="latest-projects">
    ...
    <div class="container">
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/unicorn/unicorn.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/unicorn/unicorn_admin.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/elite/elite.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/elite/elite_admin.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/sipexpress/sipexpress.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/sipexpresskurir/sipexpresskurir.png">
        </div>
        ...
        <div data-aos="fade-up" class="text-center mt-3 mb-4">
            <img class="img-unicorn img-fluid" src="/static/img/inline/inline.png">
        </div>
